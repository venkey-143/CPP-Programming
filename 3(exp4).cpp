...
// Intermediate Derived class class Derived1 : public Base { public:
Derived1() {
...
int main() {
cout << "Creating object of Derived2 class..." << endl; Derived2 obj; // Object creation

...
//	Multi-level Inheritance class Parent {
public:
void displayParent() {
...
//	Hierarchical Inheritance class Base {
public:
void displayBase() {
...
class P : public N, public O { public:
void displayP() {
...
cout << "\n--- Multi-level Inheritance ---" << endl; GrandChild gc;
gc.displayParent(); gc.displayChild(); gc.displayGrandChild();

cout << "\n--- Hierarchical Inheritance ---" << endl; Derived1 d1;
Derived2 d2; d1.displayBase(); d1.displayDerived1(); d2.displayBase(); d2.displayDerived2();

cout << "\n--- Hybrid Inheritance ---" << endl; P;
p.displayM();
p.displayN();
p.displayO();
p.displayP();
